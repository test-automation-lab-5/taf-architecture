...
public class GmailTest {
    ...
    public void manipulateGmail() throws InterruptedException {
        ...
        List<WebElement> titles = driver.findElements(By.xpath("//div[contains(@class, 'UI')]//div[contains(@role, 'tabpanel')]//span[contains(@class, 'bog')]"));
...
//        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//span[contains(@gh, 'mll')]")).click();

        (new WebDriverWait(driver, 15))
                .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div.TK a[title='Trash']")));
        driver.findElement(By.cssSelector("div.TK a[title='Trash']")).click();

        Thread.sleep(1000);
        List<String> deletedList = new ArrayList<String>();
        List<WebElement> deleted = driver.findElements(By.xpath("//div[@role='main']//div[contains(@gh, 'tl')]//span[contains(@class, 'bog')]"));
